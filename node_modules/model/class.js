...
Class.extend = function(prop, classname) {
	...
	logger.debug('_super : '+ sys.inspect(_super));
	logger.debug('prototype : '+ sys.inspect(prototype));
	...
	for (var name in _super) {
		if (name !== 'map') {
			prototype[name] = typeof _super[name] == "function" && 
			  typeof _super[name] == "function" && fnTest.test(_super[name]) ?
				  (function(name, fn){
					  return function() {
						  var tmp = this._super;
