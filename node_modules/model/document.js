...
Document = karacos.model.Class.extend({
	...
	init: function(values) {
		logger.debug("Initializing new Document with values : " + sys.inspect(values));
		this._data = values;
		this.logger = log4js.getLogger('karacos.model.' + values.type + ':' + values.name);
...
Document.create = function(data, callback) {
	...
	console.log(karacos.model[data.type].prototype.map);
