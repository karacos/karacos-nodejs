...
function process_obj_template(req,obj, callback) {
	var tmplFile, compiled, compiledId, source, context;
	compileId = obj._data.id;
	console.log(dust.cache);
	source = String(fs.readFileSync("./resources/templates/system.html"));
	compiled = jqtpl.template(compileId,source);
	callback(undefined,jqtpl.tmpl(compiled, {'instance': obj}));
	//dust.loadSource(compiled);
	//console.log(obj.get_theme());
//	context = {'instance': function() {
//		console.log("Getting instance : " + obj);
//		this = obj;
//		}
//	};
...
function processRequest(req,res) {
	logger.debug("Header: Host" + req.headers.host + " Url:" + req.url);
